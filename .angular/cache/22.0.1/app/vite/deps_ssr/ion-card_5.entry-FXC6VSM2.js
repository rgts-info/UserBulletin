...
var Card = class {
  ...
  renderCard(mode) {
    ...
    return h(TagType, __spreadProps(__spreadValues(__spreadValues({}, attrs), inheritedAriaAttributes), { class: "card-native", part: "native", disabled: this.disabled, onClick: (ev) => openURL(href, ev, routerDirection, routerAnimation) }), h("slot", null), clickable && mode === "md" && h("ion-ripple-effect", null));
  }
  render() {
...
//# sourceMappingURL=ion-card_5.entry-FXC6VSM2.js.map
