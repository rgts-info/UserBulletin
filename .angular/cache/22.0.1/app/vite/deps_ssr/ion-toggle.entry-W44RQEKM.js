...
var Toggle = class {
   ...
   */
  enableOnOffLabels = config.get("toggleOnOffLabels");
  /**
  ...
  getSwitchLabelIcon = (mode, checked) => {
    if (mode === "md") {
...
//# sourceMappingURL=ion-toggle.entry-W44RQEKM.js.map
