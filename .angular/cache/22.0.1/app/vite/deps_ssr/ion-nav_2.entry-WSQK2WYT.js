...
var Nav = class {
  ...
  async componentDidLoad() {
    this.didLoad = true;
    this.rootChanged();
    this.gesture = (await import("./swipe-back-C9HW1bug-ZMU5LFXM.js")).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
//# sourceMappingURL=ion-nav_2.entry-WSQK2WYT.js.map
