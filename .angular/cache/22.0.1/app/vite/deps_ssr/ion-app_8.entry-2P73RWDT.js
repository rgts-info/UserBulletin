  ...
  componentDidLoad() {
    {
      this.rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-Clc-28O1-E57NUTKF.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-CHB7KwIb-4OTRZG7G.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-B8sfni1e-T44FKZBD.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./hardware-back-button-gLJHMX_F-6SEVHCLM.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-Cj8mLJeq-J2FGCV6I.js").then((module) => module.startKeyboardAssist(window));
        }
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./swipe-back-C9HW1bug-ZMU5LFXM.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
...
//# sourceMappingURL=ion-app_8.entry-2P73RWDT.js.map
