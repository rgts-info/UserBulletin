...
var INDICATOR_CONTROL_SELECTOR = "ion-checkbox, ion-radio, ion-toggle";
var Item = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  labelColorStyles = {};
  itemStyles = /* @__PURE__ */ new Map();
  inheritedAriaAttributes = {};
  indicatorControlObserver;
  didLoad = false;
  get el() {
  ...
  focusable = true;
  isInteractive = false;
  hasSlottedIndicatorControl = false;
  /**
  ...
  disconnectedCallback() {
    if (this.indicatorControlObserver) {
      ...
      this.indicatorControlObserver = void 0;
    }
  }
  totalNestedInputs() {
  ...
  updateInteractivityOnSlotChange = () => {
    this.setIsInteractive();
    this.setMultipleInputs();
    this.setHasSlottedIndicatorControl();
  };
  ...
  render() {
    ...
    return h(Host, { key: "0dc161ad7ac2fdedc5005015fceb34ed176010a6", "aria-disabled": ariaDisabled, class: __spreadValues(__spreadValues(__spreadValues({}, childStyles), labelColorStyles), createColorClasses(this.color, {
      item: true,
      [mode]: true,
    ...
    })), role: inList ? "listitem" : null }, h(TagType, __spreadValues(__spreadProps(__spreadValues(__spreadValues({ key: "d42583cf62133b2553de2e7a5357168640bb1834" }, attrs), inheritedAriaAttributes), { class: "item-native", part: "native", disabled }), clickFn), h("slot", { key: "bd805ce49946cd52280d1c4b370104ee2472f1e2", name: "start", onSlotchange: this.updateInteractivityOnSlotChange }), h("div", { key: "0de589f9c5c13c31b6c8838566a7ad6f78f81028", class: "item-inner", part: "inner" }, h("div", { key: "faaf6a39e072fb352753c645736ab1f47c2d7d25", class: "input-wrapper", part: "container" }, h("slot", { key: "70a34c31de29a0786a14b4a7d3156ba8d4d92eb4", onSlotchange: this.updateInteractivityOnSlotChange })), h("slot", { key: "c8e764b62c5c30f67750896741ca266b741d5999", name: "end", onSlotchange: this.updateInteractivityOnSlotChange }), showDetail && h("ion-icon", { key: "af006856d8c4ed69174534261344215957cc751a", icon: detailIcon, lazy: false, class: "item-detail-icon", part: "detail-icon", "aria-hidden": "true", "flip-rtl": detailIcon === chevronForward })), canActivate && mode === "md" && h("ion-ripple-effect", { key: "e5e151bafedd38feb8f71a387a0059aa1e9e90de" })));
  }
  static get watchers() {
    return {
      "button": [{
...
var touchesIndicatorControl = (record) => Array.from(record.addedNodes).some(isIndicatorControl) || Array.from(record.removedNodes).some(isIndicatorControl);
Item.style = {
  ios: itemIosCss(),
  md: itemMdCss()
};
...
//# sourceMappingURL=ion-item_8.entry-U6J2I3UY.js.map
