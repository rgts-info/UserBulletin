...
} from "./chunk-EVRFL434.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-W5RX2GGE.js";
import "./chunk-WPYU7YNH.js";
import {
  ...
  componentDidLoad() {
    {
      this.rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-Clc-28O1-3IBR36BQ.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-CHB7KwIb-YZUHYIXK.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-B8sfni1e-QZHHYUXZ.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./hardware-back-button-gLJHMX_F-BCGOO5BN.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-Cj8mLJeq-ZWV6566R.js").then((module) => module.startKeyboardAssist(window));
        }
...
var Content = class {
  ...
  setupFullscreenResizeObserver() {
    ...
    if (this.fullscreenResizeObserver !== void 0) {
      return;
    }
  ...
  destroyFullscreenResizeObserver() {
    if (this.fullscreenResizeObserver !== void 0) {
      ...
      this.fullscreenResizeObserver = void 0;
    }
  }
  /**
  ...
  render() {
    ...
    this.resize();
    return h(Host, __spreadValues({ key: "9551c759df407b10d809171641fc6e8f14d92219", role: isMainContent ? "main" : void 0, class: createColorClasses(this.color, {
      [mode]: true,
    ...
    } }, inheritedAttributes), h("div", { key: "c6de8fd226f0d10a534eb107fe032ac155fbe68e", ref: (el2) => this.backgroundContentEl = el2, id: "background-content", part: "background" }), fixedSlotPlacement === "before" ? h("slot", { name: "fixed" }) : null, h("div", { key: "082fc2936061360060b48221ecb1c864a3711fa0", class: {
      "inner-scroll": true,
      "scroll-x": scrollX,
      "scroll-y": scrollY,
      overscroll: (scrollX || scrollY) && forceOverscroll
    }, ref: (scrollEl) => this.scrollEl = scrollEl, onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : void 0, part: "scroll" }, h("slot", { key: "0d2286206facb22696a9ca7e74a3f6b7d2397aab" })), transitionShadow ? h("div", { class: "transition-effect" }, h("div", { class: "transition-cover" }), h("div", { class: "transition-shadow" })) : null, fixedSlotPlacement === "after" ? h("slot", { name: "fixed" }) : null);
  }
  static get watchers() {
    return {
      "fullscreen": [{
...
var Header = class {
  ...
  render() {
    ...
    return h(Host, __spreadValues({ key: "863c4568cd7b8c0ec55109f193bbbaed68a1346e", role: roleType, class: {
      [mode]: true,
      // Used internally for styling
      [`header-${mode}`]: true,
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./swipe-back-C9HW1bug-SPVXTOMT.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
  ...
  updateGestureEnabled() {
    if (this.gesture) {
      this.gesture.enable(this.swipeHandler !== void 0 && this.swipeGesture === true);
    }
  }
  disconnectedCallback() {
    if (this.gesture) {
  ...
  async transition(enteringEl, leavingEl, opts = {}) {
    ...
    await transition(__spreadProps(__spreadValues({
      mode,
      animated,
      enteringEl,
      leavingEl,
...
var Toolbar = class {
  ...
  childrenStyles = /* @__PURE__ */ new Map();
  get el() {
    return getElement(this);
  }
  /**
  ...
  render() {
    ...
    return h(Host, { key: "c16803dc4eae9972ef19bf43aa74b94feb4fd4c1", class: __spreadValues(__spreadValues({}, childStyles), createColorClasses(this.color, {
      [mode]: true,
...
//# sourceMappingURL=ion-app_8.entry-EGH6NB5W.js.map
