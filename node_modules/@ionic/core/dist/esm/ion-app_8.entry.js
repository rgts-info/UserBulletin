...
import { i as inheritAriaAttributes, h as hasLazyBuild, c as componentOnReady, e as clamp, s as shallowEqualStringMap } from './helpers-CAGf8Wgp.js';
import { i as isRTL } from './dir-Dojwmvde.js';
import { h as hostContext, c as createColorClasses } from './theme-byZM6qHV.js';
import { b as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-T0JxBI8V.js';
import { c as createKeyboardController } from './keyboard-controller-DEwoa1ev.js';
import { g as getTimeGivenProgression } from './cubic-bezier-hHmYLOfE.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-BHTU2Ip9.js';
import { c as createLockController } from './lock-controller-B-hirT0v.js';
import { t as transition } from './index-WlteAIqz.js';
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-C9HW1bug.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
