 ...
 */
import { r as registerInstance, c as createEvent, g as getElement, f as printIonWarning, w as writeTask, e as config, h, d as Host } from './index-ChhhtsGZ.js';
import { i as isIonContent, f as findRefresherInContent, a as findClosestIonContent, d as disableContentScrollY, r as resetContentScrollY, b as findIonContent, p as printIonContentErrorMsg } from './index-T0JxBI8V.js';
import { C as CoreDelegate, a as attachComponent, d as detachComponent } from './framework-delegate-BHTU2Ip9.js';
import { g as getElementRoot, e as clamp, r as raf, b as inheritAttributes, h as hasLazyBuild } from './helpers-CAGf8Wgp.js';
import { c as createLockController } from './lock-controller-B-hirT0v.js';
import { g as getCapacitor } from './capacitor-CFERIeaU.js';
import { G as GESTURE, O as OVERLAY_GESTURE_PRIORITY, F as FOCUS_TRAP_DISABLE_CLASS, d as createTriggerController, h as prepareOverlay, j as cleanupRootFocusTrapAccessibility, k as setOverlayId, e as present, f as dismiss, g as eventMethod, B as BACKDROP } from './overlays-CPmIs9Ls.js';
import { g as getClassMap } from './theme-byZM6qHV.js';
import { e as deepReady, w as waitForMount } from './index-WlteAIqz.js';
import { b as getIonMode } from './ionic-global-BVB7BrLT.js';
import { KEYBOARD_DID_OPEN } from './keyboard-Cj8mLJeq.js';
import { c as createAnimation } from './animation-CGFdmGk9.js';
import { g as getTimeGivenProgression } from './cubic-bezier-hHmYLOfE.js';
import { createGesture } from './index-DcPaH5uL.js';
...
const Modal = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'a471c293319cb6ee5ffb7ffafec0b8413e4289de', "no-router": true,
            ...
            }, onIonBackdropTap: this.onBackdropTap, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle, onFocus: this.onModalFocus }, h("ion-backdrop", { key: 'f67934afd4ddad64623856fb641cb6db846df428', ref: (el) => (this.backdropEl = el), visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === 'ios' && h("div", { key: 'a23f5cb6cf60c8f717c1dd556bce375829c80a43', class: "modal-shadow" }), h("div", { key: '51eb6cd1070e4b7e49840a78dc7437238c867a01',
            /*
            ...
            */
            role: "dialog", ...inheritedAttributes, "aria-modal": "true", tabIndex: -1, class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: (el) => (this.wrapperEl = el) }, showHandle && (h("button", { key: 'f49a144642b5c227c0c2b00b33f4c7e37a2bf088', class: "modal-handle",
            // Prevents the handle from receiving keyboard focus when it does not cycle
            tabIndex: !isHandleCycle ? -1 : 0, "aria-label": "Activate to adjust the size of the dialog overlaying the screen", onClick: isHandleCycle ? this.onHandleClick : undefined, part: "handle", ref: (el) => (this.dragHandleEl = el) })), h("slot", { key: 'e781c0d5881762c6b61aa432721a38b49580ff64', onSlotchange: this.onSlotChange }))));
    }
