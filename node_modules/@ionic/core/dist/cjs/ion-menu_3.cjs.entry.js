...
const Menu = class {
    ...
    lastOnEnd = 0;
    gesture;
    blocker = gestureController.GESTURE_CONTROLLER.createBlocker({ disableScroll: true });
    didLoad = false;
    /**
