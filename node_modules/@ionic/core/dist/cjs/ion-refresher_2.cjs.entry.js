...
const Refresher = class {
    ...
    async setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
        ...
        const { createGesture } = await Promise.resolve().then(function () { return require('./index-DwlRtFZe.js'); });
        /**
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b76e9fb79121799717063137135e448a3c784d82', slot: "fixed", class: {
                [mode]: true,
