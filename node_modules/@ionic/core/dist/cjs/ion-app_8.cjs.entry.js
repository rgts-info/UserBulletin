...
var index$2 = require('./index-BLdJCcJY.js');
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-B7X9VOlH.js'); })).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
