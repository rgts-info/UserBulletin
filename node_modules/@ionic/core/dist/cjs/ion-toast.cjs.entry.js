...
var index$1 = require('./index-uvry__L4.js');
...
var index$3 = require('./index-B7zJsYWS.js');
...
const Toast = class {
    ...
    customHTMLEnabled = index$1.config.get('innerHTMLTemplatesEnabled', config.ENABLE_HTML_CONTENT_DEFAULT);
    durationTimeout;
    gesture;
    /**
     ...
     */
    duration = index$1.config.getNumber('toastDuration', 0);
    /**
