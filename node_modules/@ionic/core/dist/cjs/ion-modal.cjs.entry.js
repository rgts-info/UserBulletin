...
var index$3 = require('./index-uvry__L4.js');
var index$1 = require('./index-zVCah4Uz.js');
var frameworkDelegate = require('./framework-delegate-Dfo5XsGv.js');
...
var index$4 = require('./index-BLdJCcJY.js');
...
var index$2 = require('./index-DwlRtFZe.js');
...
const Modal = class {
    ...
    gesture;
    coreDelegate = frameworkDelegate.CoreDelegate();
    sheetTransition;
    isSheetModal = false;
    /**
    ...
    render() {
        ...
        return (index$3.h(index$3.Host, { key: 'a471c293319cb6ee5ffb7ffafec0b8413e4289de', "no-router": true,
            ...
            }, onIonBackdropTap: this.onBackdropTap, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle, onFocus: this.onModalFocus }, index$3.h("ion-backdrop", { key: 'f67934afd4ddad64623856fb641cb6db846df428', ref: (el) => (this.backdropEl = el), visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === 'ios' && index$3.h("div", { key: 'a23f5cb6cf60c8f717c1dd556bce375829c80a43', class: "modal-shadow" }), index$3.h("div", { key: '51eb6cd1070e4b7e49840a78dc7437238c867a01',
            /*
            ...
            */
            role: "dialog", ...inheritedAttributes, "aria-modal": "true", tabIndex: -1, class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: (el) => (this.wrapperEl = el) }, showHandle && (index$3.h("button", { key: 'f49a144642b5c227c0c2b00b33f4c7e37a2bf088', class: "modal-handle",
            // Prevents the handle from receiving keyboard focus when it does not cycle
            tabIndex: !isHandleCycle ? -1 : 0, "aria-label": "Activate to adjust the size of the dialog overlaying the screen", onClick: isHandleCycle ? this.onHandleClick : undefined, part: "handle", ref: (el) => (this.dragHandleEl = el) })), index$3.h("slot", { key: 'e781c0d5881762c6b61aa432721a38b49580ff64', onSlotchange: this.onSlotChange }))));
    }
